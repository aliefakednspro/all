...
if(!empty($html_scr['subCategories'])){
	...
	if($ifcatname){
$pagestitle= "Hot Product In ".$CATEGORY_NAME." Category".$pagesname;
$metadesc= "Cheap Shopping ".$CATEGORY_NAME.", Browse Through Our Directory of ".$CATEGORY_NAME.$pagesname.", ".joincategory($morecats).", Worldwide Shipping!";
	}else{
$pagestitle= "Wholesale Various High Quality Best Selling Products";
$metadesc= "Best Selling Products Automotive, Phones Accessories, Computers Electronics, Fashion, Beauty Health, Home Garden, Toys Sports, Weddings";
	}
